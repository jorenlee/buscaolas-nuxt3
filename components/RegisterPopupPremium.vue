...
//       try {
//         let response = await this.$axios.$put("/api/main/update-phone/" + this.user_id);
...
<template>
  <div class="mx-auto w-800 bg-gradient mt-10">
    <div class="relative">
      <button
        class="absolute right-8 top-7 top-16 block flex text-sm text-white leading-7"
        @click="Close()"
      >
        cerrar
    ...
    <div class="lg:px-10 px-8 lg:pt-10 pt-5 lg:pb-16 pb-3">
      <div class="mx-auto text-white lg:w-10/12">
        ...
        <form class="lg:w-min mx-auto text-center" v-if="RegisterForm">
          <input
            placeholder="nombre"
            class="block rounded-sm text-xs text-center text-wide bg-white lg:w-80 w-full py-2 mb-9 text-dark-gray uppercase"
            v-model="first_name"
          />
          <input
          ...
          <select
            ...
            class="rounded-sm text-xs text-wide bg-white lg:w-80 w-full py-2 mb-9 text-center uppercase text-dark-gray"
            required
          >
        ...
        >
          <input
            placeholder="email"
            class="block rounded-sm text-sm text-center text-blue text-wide bg-gray lg:w-80 w-full py-2 mb-9"
            v-model="email"
          />
          <input
            placeholder="contraseña"
          ...
          <button
            type="submit"
            class="font-bold text-base text-center letter-spacing-0-25-em uppercase text-white block bg-blue-green rounded-sm mt-9 mx-auto py-2 px-10 whitespace-nowrap"
          >
            Iniciar Sesion
          </button>
