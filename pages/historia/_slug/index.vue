<template>
  <div>
    <Header />
    <div id="modalloading" class="loading-modal">
    <div class="loading-modal-content">
      <h1 class="textLoader">Creando video... </h1>
...
//css for the loader
.loading-modal{z-index:3; display:none;padding-top:100px;position:fixed;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgb(0,0,0);background-color:rgba(0,0,0,0.4)}
.loading-modal-content{margin:auto;}
.loader {
  position: absolute;
  left: 50%;
  top: 50%;
