export default {
  ...
  head: {
    ...
    link: [
      ...
      {rel: 'stylesheet', href: '/nuevodel/shaka/videojs.min.css'}
    ],
    script: [
      { src: '/nuevodel/nuevo.min.js'}
      // {src: '//vjs.zencdn.net/8.3.0/video.min.js'},
      // {src: 'js/head/hotjar.js'}
    ]
  },
  ...
  css: [
    '@/assets/css/main.css',
    // '@/assets/skins/shaka/videojs.min.css',
  ],
